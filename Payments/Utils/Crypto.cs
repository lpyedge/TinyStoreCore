...
#pragma warning restore CS0618
    ...
    public static class RSACrypto
    {
        ...
        public static RSACryptoServiceProvider FromPEM(string pem)
        {
            ...
            { 
                return  readPublicPem(pem);
            }
            else if (pem.Contains("PRIVATE KEY"))
            {
                return  readPrivatePem(pem);
            }
            else
            {
                try
        ...
        private static RSACryptoServiceProvider readPrivatePem(string pem)
        {
        ...
        private static RSACryptoServiceProvider readPublicPem(string pem)
        {
            var base64 = Extensions._PEMCode.Replace(pem, "");
            var data = Convert.FromBase64String(base64);
            if (data == null)
