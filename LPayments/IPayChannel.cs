...
namespace LPayments
{
    public abstract class IPayChannel
    {
        ...
        // /// </summary>
        // /// <returns></returns>
        // public abstract PayResult Notify(IDictionary<string, string> form, IDictionary<string, string> query,
        ...
        // /// <returns></returns>
        // public abstract PayTicket Pay(string p_OrderId, double p_Amount,
