    ...
    public class ApiAdminController : ControllerBase
    {
        ...
        public IActionResult Login([FromForm] string account, [FromForm] string password)
        {
            ...
            if (admin != null && string.Equals(admin.Password, Global.Hash(password, admin.Salt),StringComparison.OrdinalIgnoreCase))
            {
                ...
                Response.Headers[AdminHeaderToken.TokenKey] = HeaderToken.ToHeaderToken( new HeaderToken.TokenData()
                {
        ...
        public IActionResult UserSave(Model.UserStoreView userStore)
        {
            ...
            else
            {
                ...
                var userExtendOrigin = BLL.BaseBLL<UserExtendModel>.QueryModelById(userStore.UserId);
